...
void Level_11::loadBackground(){
	background = Image::load("data/images/level_11.png");
}

void Level_11::loadBottomGrass(){
...
int Level_11::getInitialResources(){
	return 1000;
}

int Level_11::getResourcesIncrement(){
	return 10;
}
