...
void Level_08::loadBackground(){
	background = Image::load("data/images/level_08.png");
}

void Level_08::loadBottomGrass(){
...
int Level_08::getInitialResources(){
	return 1000;
}

int Level_08::getResourcesIncrement(){
	return 10;
}
