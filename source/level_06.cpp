...
void Level_06::loadBackground(){
	background = Image::load("data/images/level_06.png");
}

void Level_06::loadBottomGrass(){
...
int Level_06::getInitialResources(){
	return 1000;
}

int Level_06::getResourcesIncrement(){
	return 10;
}
