...
void Level_07::loadBackground(){
	background = Image::load("data/images/level_07.png");
}

void Level_07::loadBottomGrass(){
...
int Level_07::getInitialResources(){
	return 1000;
}

int Level_07::getResourcesIncrement(){
	return 10;
}
