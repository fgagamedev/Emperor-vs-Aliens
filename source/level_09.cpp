...
void Level_09::loadBackground(){
	background = Image::load("data/images/level_09.png");
}

void Level_09::loadBottomGrass(){
...
int Level_09::getInitialResources(){
	return 1000;
}

int Level_09::getResourcesIncrement(){
	return 10;
}
