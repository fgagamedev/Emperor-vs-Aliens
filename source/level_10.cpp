...
void Level_10::loadBackground(){
	background = Image::load("data/images/level_10.png");
}

void Level_10::loadBottomGrass(){
...
int Level_10::getInitialResources(){
	return 1000;
}

int Level_10::getResourcesIncrement(){
	return 10;
}
